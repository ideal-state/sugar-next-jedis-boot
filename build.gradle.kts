    ...
    publications {
        main {
            pom {
                ...
                url.set("https://github.com/ideal-state/sugar-next-jedis-boot")
                licenses {
                    license {
                ...
                scm {
                    url.set("https://github.com/ideal-state/sugar-next-jedis-boot")
                    connection.set("scm:git:https://github.com/ideal-state/sugar-next-jedis-boot.git")
                    developerConnection.set("scm:git:https://github.com/ideal-state/sugar-next-jedis-boot.git")
                }
                developers {
                    developer {
                        id.set("ideal-state")
